...
public class Notification: INotification {
    ...
    */
    public class func withName(_ name: String, body: Any?, type: String?) -> Notification {
        return Notification(name: name, body: body, type: type);
    }

    public class func withName(_ name: String) -> Notification {
        return Notification(name: name, body: nil, type: nil)
    }

    public class func withName(_ name: String, body: AnyObject?) -> Notification {
        return Notification(name: name, body: body, type: nil)
    }

   public  class func withName(_ name: String, type: String?) -> Notification {
    ...
    * @param type the type of the <code>Notification</code>
    */
    public init(name: String?, body: Any?, type: String?) {
        self.name = name!;
        self.body = body;
        self.type = type;
    }
