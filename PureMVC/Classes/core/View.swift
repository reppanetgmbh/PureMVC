    ...
    */
    func registerMediator( _ mediator: IMediator )
    {
        ...
        if ( interests.count > 0 )
        {
            ...
            let observer : IObserver = Observer.withNotifyMethod( mediator.handleNotification , notifyContext: mediator )
    ...
    */
    func removeMediator( _ mediatorName: String ) -> IMediator
    {
        ...
        if ( mediator != nil )
        {
            ...
            for notificationName in interests
            {
                self.removeObserver( notificationName , notifyContext: mediator as AnyObject )
            }
            mediator!.onRemove()
