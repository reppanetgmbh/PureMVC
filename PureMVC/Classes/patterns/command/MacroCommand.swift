...
open class MacroCommand : Notifier, ICommand
{
    ...
    public var subCommands : Array<Notifier.Type>?
    
    /**
    * Static Convenience Constructor.
    */
    open class func command () -> MacroCommand
    {
        return MacroCommand()
    }
    ...
    */
    public func addSubCommand( _ commandClass : Notifier.Type? )
    {
    ...
    */
    public func execute( _ notification: INotification )
    {
