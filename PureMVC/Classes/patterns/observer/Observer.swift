...
class Observer : IObserver
{
    ...
    var notifyMethod : ( _ notification: INotification ) -> Void
    var notifyContext : AnyObject
    
    /**
    * Static Convienence Constructor.
    */
    class func withNotifyMethod( _ notifyMethod: @escaping ( _ notification: INotification ) -> Void , notifyContext: AnyObject ) -> Observer
    {
    ...
    */
    init( notifyMethod: @escaping ( _ notification: INotification ) -> Void , notifyContext: AnyObject )
    {
