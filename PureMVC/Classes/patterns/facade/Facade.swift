...
open class Facade : IFacade
{
    ...
    private static  func __once() {
        guard Static.instance == nil else {
            return
        }
    ...
    {
        public static var instance : Facade? = nil
    }
    ...
    */
    open class func getInstance() -> Facade
    {
        Facade.__once()
    ...
    */
    ...
    {
        self.sendNotification( notificationName , body:body , type:type, sync: false )
    }
    ...
    */
    public func hasCommand( _ notificationName: String ) -> Bool
    {
    ...
    */
    public func hasMediator ( _ mediatorName: String ) -> Bool
    {
    ...
    */
    public func hasProxy ( _ proxyName: String ) -> Bool
    {
    ...
    */
    public func notifyObservers( _ notification: INotification )
    {
    ...
    */
    public func registerCommand ( _ notificationName: String , commandClass: Notifier.Type )
    {
    ...
    */
    public func registerMediator ( _ mediator: IMediator )
    {
    ...
    */
    public func registerProxy ( _ proxy: IProxy )
    {
    ...
    */
    public func removeCommand ( _ notificationName: String )
    {
    ...
    */
    public func removeMediator ( _ mediatorName: String ) -> IMediator
    {
    ...
    */
    public func removeProxy ( _ proxyName: String ) -> IProxy
    {
    ...
    */
    public func retrieveMediator ( _ mediatorName: String ) -> IMediator
    {
    ...
    */
    public func retrieveProxy ( _ proxyName: String ) -> IProxy
    {
